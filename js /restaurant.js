...
//Anonymous function
// var avg = function(a) { return (0 + a)/2.0};
...
// Favorite button 
var hLabel = document.getElementById("heartLabel");
var hCheck = document.getElementById("heartCheck");
function fave() {
    if (hCheck.checked) { // ref for detecting checked/unchecked: https://stackoverflow.com/questions/6358673/javascript-checkbox-onchange
        hLabel.className = "btn btn-danger";
        // ref for className: https://www.w3schools.com/jsref/prop_html_classname.asp
    } else {
        hLabel.className = "btn btn-light";
    }
}
